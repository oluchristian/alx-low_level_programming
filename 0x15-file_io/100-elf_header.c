...
/**
 * check_elf - A Check if a file is an ELF file.
 * @e_ident: pointer to an array containing the ELF magic numbers.
 *
 * Description: If the file is not an ELF file - exit code.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_data -it will  Prints the data of an ELF header.
...
/**
 * print_version -it will  Print the version of an ELF header.
...
/**
 * close_elf -it Close an ELF file.
...
/**
 * main - it will Display the information contained in the
